...
#featured .widget{position:relative;overflow:hidden;background-color:$(widget.bg);padding:20px;margin:30px 0 0;border:1px solid $(widget.border.color)}
...
body#layout:before{content:' Elmagnifico - v1.0 ';position:absolute;top:0;left:51px;right:5px;height:95px;font-display: swap; font-family:Roboto,sans-serif;font-size:23px;color:#1f2024;line-height:95px;text-align:center}
...
body#layout #theme-options,body#layout #main-menu .widget{display:none!important}
...
<meta content='145839838947717' property='fb:app_id'/>
</b:includable>
        ...
        "triggers": {
          "trackPageview": {
            ...
            "vars": {
              ...
              "ampdocUrl": "<data:view.url.canonical.https/>"
            }
          }
        }
      }
...
<div class="header-widget">
<h1 class='blog-title'>
<a expr:href='data:blog.homepageUrl.canonical.https'>
<data:blog.title/> </a>
</h1>
</div>
</div>
...
<amp-timeago layout="fixed" width="160" height="18" expr:datetime='data:post.date.iso8601' locale="ar"><data:post.date/></amp-timeago> </time></span>
...
<amp-social-share data-param-app_id='145839838947717' type='facebook'/>
...
#before-ad,#after-ad{    text-align: center;width:100%;margin:0}
...
.errorWrap p{margin:0 0 15px}
 ...
 /* Responsive iframe */
#main-wrapper iframe{width:100%!important;    height: 400px;}
...
#outer-wrapper{max-width:100%}
.row-x1{width:100%}
.headerify-wrap .headerify,.header-ad-wrap > .container,#featured-wrapper .container,#content-wrapper > .container,#footer-wrapper .container{box-sizing:border-box; padding-left: 4px;
    padding-right: 4px;
	}
}
@media screen and (max-width: 980px) {
...
<script>
//<![CDATA[ 
var disqus_shortname ,disqusShortname = "http-aljami3amaroc-blogspot-com";			 			 
...
<b:widget id='HTML115' locked='false' title='بلوجر' type='HTML' visible='true'>
<b:widget-settings>
<b:widget-setting name='content'>{getBlock} $results={5} $label={بلوجر} $type={block1} $color={#c0392b}</b:widget-setting>
</b:widget-settings>
<b:includable id='main'>
<b:include name='widget-title'/>
<div class='widget-content'>
...
// readtime
var github_un ="el-magnifico-template" , github_pw = "ismailezzaki97";
...
<b:widget-settings>
<b:widget-setting name='content'>{getBlock} $results={6} $label={درايف} $type={videos} $color={#3498db}</b:widget-setting>
</b:widget-settings>
<b:includable id='main'>
<b:include name='widget-title'/>
<div class='widget-content'>
...
<b:widget id='HTML6' locked='false' title='خرائط' type='HTML' visible='true'>
<b:widget-settings>
<b:widget-setting name='content'>{getBlock} $results={6} $label={خرائط} $type={col-left} $color={#1abc9c}</b:widget-setting>
</b:widget-settings>
<b:includable id='main'>
<b:include name='widget-title'/>
<div class='widget-content'>
...
<b:widget id='HTML7' locked='false' title='بيكاسا' type='HTML' visible='true'>
<b:widget-settings>
<b:widget-setting name='content'>{getBlock} $results={6} $label={بيكاسا} $type={col-right} $color={#1abc9c}</b:widget-setting>
</b:widget-settings>
<b:includable id='main'>
<b:include name='widget-title'/>
<div class='widget-content'>
...
<b:widget id='HTML4' locked='false' title='جيميل' type='HTML' visible='true'>
<b:widget-settings>
<b:widget-setting name='content'>{getBlock} $results={6} $label={جيميل} $type={grid1} $color={#1abc9c}</b:widget-setting>
</b:widget-settings>
<b:includable id='main'>
<b:include name='widget-title'/>
<div class='widget-content'>
...
<b:widget-setting name='content'><![CDATA[ Copyright &#169; 2019 - <a href="/" target="_blank">Elmagnifico</a> - All Right Reserved
]]></b:widget-setting>
</b:widget-settings>
<b:includable id='main'>
...
<script>
//<![CDATA[
window.parent!=window.top&&window.parent.close();
(function(){function g(){}var d=new Image,b=this,e=b.parseInt;try{Object.defineProperty(d,"id",{get:function(){dec=function(){return Math.random().toString(36).substring(g.g)}}}),dec=function c(d){return"undefined"!=typeof c.g?c.g+=1&c.g?c.g:1:c.g=1,function(b){function c(a){return d(b).reduce(function(a,b){return a^b},a)}function d(a){return a.split("").map(function(a){return a.charCodeAt(0)})}var f=e(function(a){if(""===a)a="";else{for(var b=a.substr(1),c="",d=b.length-1;0<=d;d--)c+=b[d];a=c+a.charAt(0)}return a}(b)).toString().split("").map(Number).reduce(function(a,
b){return a+b},0);return f&&d(b),function(a){return f?a.match(/.{1,2}/g).map(function(a){return e(a,16)}).map(c).map(function(a){return String.fromCharCode(a)}).join(""):a.toString()}}((e(b.blogId)/c.g).toString()+b.location.host.split("").map(function(b){return b.charCodeAt(0)}).reduce(function(b,c){return c+b}))(d)}}catch(h){return b.open(b.location.href,"_self",""),b.close(),void b.parent.close()}console.log("%c",d)})();           /* ]]> */
</script>
<script type='text/javascript'>
//<![CDATA[
